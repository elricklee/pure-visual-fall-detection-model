...
| 平均延迟 | 22.6889ms | 15.3775ms | 降低32.22% |
| P95延迟 | 39.2822ms | 20.7609ms | 降低47.15% |
| FPS | 44.074 | 65.030 | 提升47.55% |
| 进程峰值RSS | 103.9196MB | 100.2578MB | 降低3.52% |
...
- `reports/day3_int8_pc_quantization.json`
- `reports/day3_int8_pc_model_audit.json`
- `reports/day3_int8_pc_benchmark.json`
- `reports/day3_int8_fp32_benchmark_same_env.json`
- `reports/day3_int8_pc_pose_eval.json`
- `reports/day3_int8_pc_pseudo_ir_pose_eval.json`
- `reports/day3_int8_pc_output_comparison.json`
- `reports/day3_int8_video_parity_visible.json`
- `reports/day3_int8_video_parity_pseudo_ir.json`
- `reports/day3_int8_pc_npu_feasibility.json`

结论：**乙第三天任务已完成，INT8候选可进入Day 4联调；真实红外与真实NPU指标仍需后续验证。**
